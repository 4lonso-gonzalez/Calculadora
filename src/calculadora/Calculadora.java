...
public class Calculadora{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese un valor para la suma recursiva: ");
        num3 = leer.nextInt();
        
        Funciones operacion = new Funciones(num1, num2, num3);
        ...
        int recursiva = operacion.getSumaRecursiva(num3);
        ...
        do {
            ...
            System.out.println("6. SUMA RECURSIVA");
            opcion = leer.nextInt();
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("La suma recursiva del valor es: " + recursiva);
                    break;
